...
4. **Database IDs**: NEVER commit actual Notion database IDs to source code. Always use placeholder values like `REPLACE_WITH_NOTION_DATABASE_ID_FOR_ACCOUNT` in the integration test metadata files
